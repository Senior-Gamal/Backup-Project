...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('client_servers', function (Blueprint $table) {
            ...
            $table->foreignId('license_group_id')->nullable()->constrained();
            $table->foreignId('license_id')->nullable()->constrained();
            ...
            $table->foreignId('full_backup_server_id')->nullable()->constrained('backup_servers');
            $table->string('full_backup_username')->nullable();
            $table->string('full_backup_password')->nullable();
            $table->foreignId('incremental_backup_server_id')->nullable()->constrained('backup_servers');
            $table->time('incremental_backup_schedule')->nullable();
            $table->foreignId('db_backup_server_id')->nullable()->constrained('backup_servers');
